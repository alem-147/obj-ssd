...
parser.add_argument('--validation_epochs', default=10, type=int,
                    help='the number epochs')
parser.add_argument('--debug_steps', default=85, type=int,
                    help='Set the debug log output frequency.')
parser.add_argument('--last_epoch', default=0, type=int,
                    help='Set the last epoch for resuming training.')
...
if __name__ == '__main__':
    ...
    for dataset_path in args.datasets:
        if args.dataset_type == 'voc':
            ...
            label_file = os.path.join("voc-model-labels.txt")
            ...
            label_file = os.path.join("open-images-model-labels.txt")
            store_labels(label_file, dataset.class_names)
    ...
    if args.resume:
        optimizer = torch.optim.SGD([{'params': net.base_net.parameters(), 'initial_lr': args.lr}], lr=args.lr,
    ...
    for epoch in range(last_epoch + 1, args.num_epochs):
        ...
        if epoch != args.last_epoch and (epoch % args.validation_epochs == 0 or epoch == args.num_epochs - 1):
